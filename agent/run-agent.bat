@echo off
:: ═══════════════════════════════════════════════════════════════
# QS Asset Agent — Windows Launcher (Zero-Dependency Wizard Mode)
:: ═══════════════════════════════════════════════════════════════

echo.
echo  ╔══════════════════════════════════════════════════════╗
echo  ║         QS Asset Agent - Windows Launcher            ║
echo  ╚══════════════════════════════════════════════════════╝
echo.
...
if "%SERVER_IP%"=="" (
  set /p SERVER_IP="Enter QS Asset server IP (e.g., 192.168.1.50): "
)
if "%USER_EMAIL%"=="" (
...
%NODE_BIN% "%~dp0reconapm-agent.js" --server http://%SERVER_IP%:4100 --user %USER_EMAIL% --pass %USER_PASS%

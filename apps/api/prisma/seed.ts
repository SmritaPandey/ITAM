...
async function main() {
  ...
  const swCatalog = await Promise.all([
    /* 0  M365 */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Microsoft 365', publisher: 'Microsoft', category: 'Productivity', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '16.0.17328', lifecycleStatus: 'CURRENT', riskScore: 5, description: 'Enterprise productivity suite (Word, Excel, PowerPoint, Outlook, OneNote). Licensed under E5 plan for full security and compliance features.', website: 'https://www.microsoft.com/microsoft-365' } }),
    /* 1  Oracle */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Oracle Database', publisher: 'Oracle', category: 'Database', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '21c', lifecycleStatus: 'CURRENT', riskScore: 12, description: 'Enterprise relational database powering Core Banking System (CBS) and Treasury Management. Premier Support until 2029.', eosDate: new Date('2029-04-30'), website: 'https://www.oracle.com/database/' } }),
    /* 2  Adobe */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Adobe Creative Cloud', publisher: 'Adobe', category: 'Design', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '2026.1', lifecycleStatus: 'CURRENT', riskScore: 8, description: 'Design suite for Marketing and Digital Banking teams. Includes Acrobat Pro for PDF signing.', website: 'https://www.adobe.com/creativecloud.html' } }),
    /* 3  CrowdStrike */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'CrowdStrike Falcon', publisher: 'CrowdStrike', category: 'Security', isAuthorized: true, authorizationStatus: 'REQUIRED', latestVersion: '7.04', lifecycleStatus: 'CURRENT', riskScore: 3, description: 'Mandatory EDR/XDR endpoint protection agent. Required on ALL endpoints per InfoSec Policy IS-2024-007. Falcon Complete managed tier.', website: 'https://www.crowdstrike.com/falcon/' } }),
    /* 4  VMware */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'VMware vSphere', publisher: 'Broadcom', category: 'Virtualization', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '8.0 U3', lifecycleStatus: 'APPROACHING_EOL', riskScore: 42, eolDate: new Date('2027-04-02'), eosDate: new Date('2029-04-02'), description: 'Hypervisor for server virtualization. Broadcom acquisition creates licensing uncertainty. Migration to Azure Stack HCI under evaluation.', website: 'https://www.broadcom.com/products/vmware/vsphere' } }),
    /* 5  Cisco DNA */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Cisco DNA Center', publisher: 'Cisco', category: 'Network', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '2.3.7', lifecycleStatus: 'CURRENT', riskScore: 10, description: 'Intent-based networking controller for Cisco Catalyst 9000 series infrastructure across all 8 sites.', website: 'https://www.cisco.com/site/us/en/products/networking/catalyst-center/index.html' } }),
    /* 6  SAP */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'SAP S/4HANA', publisher: 'SAP', category: 'ERP', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '2023 FPS02', lifecycleStatus: 'CURRENT', riskScore: 15, description: 'Cloud ERP for finance, procurement, and HR. Handles general ledger, accounts payable/receivable, and vendor management.', website: 'https://www.sap.com/products/erp/s4hana.html' } }),
    /* 7  Tally */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Tally Prime', publisher: 'Tally Solutions', category: 'Accounting', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '4.0', lifecycleStatus: 'CURRENT', riskScore: 18, description: 'Accounting and GST compliance software used by branch-level finance teams for statutory reporting.', website: 'https://tallysolutions.com/tallyprime/' } }),
    /* 8  Chrome */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Google Chrome', publisher: 'Google', category: 'Browser', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '126.0', lifecycleStatus: 'CURRENT', riskScore: 22, description: 'Standard enterprise browser. Managed via Chrome Enterprise policies with forced auto-update. CVE monitoring active.', website: 'https://chromeenterprise.google/' } }),
    /* 9  BitTorrent — BLACKLISTED */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'BitTorrent', publisher: 'BitTorrent Inc', category: 'P2P', isBlacklisted: true, isAuthorized: false, authorizationStatus: 'BLACKLISTED', latestVersion: '7.11', lifecycleStatus: 'CURRENT', riskScore: 95, description: 'BLACKLISTED: Peer-to-peer file sharing violates data loss prevention (DLP) policy. Detected on 3 endpoints — immediate remediation required.' } }),
    /* 10 Zoom */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Zoom Workplace', publisher: 'Zoom', category: 'Communication', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '6.1.0', lifecycleStatus: 'CURRENT', riskScore: 14, description: 'Video conferencing for external client meetings. Internal meetings should use MS Teams.', website: 'https://zoom.us/' } }),
    /* 11 Teams */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Microsoft Teams', publisher: 'Microsoft', category: 'Communication', isAuthorized: true, authorizationStatus: 'REQUIRED', latestVersion: '24165.1503', lifecycleStatus: 'CURRENT', riskScore: 4, description: 'Primary internal communication and collaboration platform. Required on all employee endpoints per IT Policy.', website: 'https://www.microsoft.com/microsoft-teams' } }),
    /* 12 7-Zip */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: '7-Zip', publisher: 'Igor Pavlov', category: 'Utility', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '24.07', lifecycleStatus: 'CURRENT', riskScore: 8, description: 'Open-source archive manager. Approved alternative to WinRAR for file compression/decompression.' } }),
    /* 13 Notepad++ */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Notepad++', publisher: 'Don Ho', category: 'Utility', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '8.6.9', lifecycleStatus: 'CURRENT', riskScore: 6, description: 'Lightweight text editor used by IT and development teams for log analysis and scripting.' } }),
    /* 14 PuTTY */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'PuTTY', publisher: 'Simon Tatham', category: 'Utility', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '0.81', lifecycleStatus: 'CURRENT', riskScore: 28, description: 'SSH client for remote server management. Approved for IT/Network teams only. Regular version audits for supply chain attacks.' } }),
    /* 15 Defender */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Windows Defender', publisher: 'Microsoft', category: 'Security', isAuthorized: true, authorizationStatus: 'REQUIRED', latestVersion: '4.18.24070', lifecycleStatus: 'CURRENT', riskScore: 2, description: 'OS-level antimalware. Works alongside CrowdStrike Falcon for defense-in-depth. Managed via Intune.', website: 'https://www.microsoft.com/windows/comprehensive-security' } }),
    /* 16 Finacle */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Finacle Core Banking', publisher: 'Infosys', category: 'Banking', isAuthorized: true, authorizationStatus: 'REQUIRED', latestVersion: '11.3', lifecycleStatus: 'APPROACHING_EOL', riskScore: 55, eolDate: new Date('2027-12-31'), eosDate: new Date('2028-06-30'), description: 'Core Banking Solution (CBS) powering all retail and corporate banking operations. v11.3 approaching EOL — upgrade to Finacle 12 planned for FY2027-28.', website: 'https://www.infosys.com/products/finacle/' } }),
    /* 17 Python */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Python', publisher: 'Python Software Foundation', category: 'Development', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '3.12.4', lifecycleStatus: 'CURRENT', riskScore: 15, description: 'Programming runtime for data analytics, automation scripts, and ML models. Version 3.8 instances flagged as EOL.', website: 'https://www.python.org/' } }),
    /* 18 DBeaver */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'DBeaver', publisher: 'DBeaver Corp', category: 'Database', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '24.1.0', lifecycleStatus: 'CURRENT', riskScore: 20, description: 'Database management IDE. Restricted to DBA and development teams. Connection to production DB requires approval.' } }),
    /* 19 VLC — NEEDS_REVIEW */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'VLC Media Player', publisher: 'VideoLAN', category: 'Media', isAuthorized: false, authorizationStatus: 'NEEDS_REVIEW', latestVersion: '3.0.21', lifecycleStatus: 'CURRENT', riskScore: 35, description: 'Open-source media player. Under review — media playback capabilities may conflict with DLP policies. CVE-2023-47360 patched in 3.0.21.' } }),
    /* 20 TeamViewer — UNAUTHORIZED */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'TeamViewer', publisher: 'TeamViewer', category: 'Remote Access', isBlacklisted: false, isAuthorized: false, authorizationStatus: 'UNAUTHORIZED', latestVersion: '15.55', lifecycleStatus: 'CURRENT', riskScore: 78, description: 'UNAUTHORIZED: Remote access tool not approved by InfoSec. Use CyberArk or approved VPN instead. Detected on 5 endpoints.' } }),
    /* 21 WinRAR — APPROACHING_EOL */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'WinRAR', publisher: 'RARLAB', category: 'Utility', isAuthorized: false, authorizationStatus: 'UNAUTHORIZED', latestVersion: '7.00', lifecycleStatus: 'CURRENT', riskScore: 65, description: 'UNAUTHORIZED: Commercial archive software with known CVEs (CVE-2023-38831). Migrate to 7-Zip. Found on 12 endpoints.' } }),
    /* 22 Java 8 — EOL */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Java Runtime 8', publisher: 'Oracle', category: 'Runtime', isAuthorized: true, authorizationStatus: 'AUTHORIZED', latestVersion: '8u401', lifecycleStatus: 'EOL', riskScore: 72, eolDate: new Date('2025-03-31'), eosDate: new Date('2030-12-31'), description: 'END OF LIFE: Legacy Java 8 runtime required by Finacle CBS. Public updates ended Mar 2025. Running on Extended Support — migrate to Java 21 LTS.' } }),
    /* 23 Adobe Flash — EOS (legacy) */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Adobe Flash Player', publisher: 'Adobe', category: 'Plugin', isBlacklisted: true, isAuthorized: false, authorizationStatus: 'BLACKLISTED', latestVersion: '32.0.0.465', lifecycleStatus: 'EOS', riskScore: 98, eolDate: new Date('2020-12-31'), eosDate: new Date('2020-12-31'), description: 'BLACKLISTED/EOS: Completely unsupported since Dec 2020. Critical security risk. Found on 2 legacy ATM controller PCs — immediate removal required.' } }),
    /* 24 Slack — NEEDS_REVIEW */ prisma.softwareCatalog.create({ data: { tenantId: bankTenant.id, name: 'Slack', publisher: 'Salesforce', category: 'Communication', isAuthorized: false, authorizationStatus: 'NEEDS_REVIEW', latestVersion: '4.39.95', lifecycleStatus: 'CURRENT', riskScore: 40, description: 'Under review: Messaging app used informally by Digital Banking team. Not approved — corporate standard is MS Teams. DLP controls not configured.' } }),
  ]);

  console.log('  ✓ 25 Software Catalog entries (CSAM-enriched)');
  ...
  // ─── Rogue / Unauthorized / EOL software detections ───────────────────────
  // TeamViewer (20) — unauthorized remote access on 5 laptops
  for (const asset of installLaptops.slice(0, 5)) {
    const key = `${bankTenant.id}:${asset.id}:${swCatalog[20].id}`;
    if (!usedKeys.has(key)) { usedKeys.add(key); installationRecords.push({ tenantId: bankTenant.id, assetId: asset.id, softwareId: swCatalog[20].id, version: '15.49.2', installPath: 'C:\\Program Files\\TeamViewer', installDate: new Date(now.getTime() - 90 * 86400000), lastUsedAt: new Date(now.getTime() - 2 * 86400000) }); }
  }
  // WinRAR (21) — unauthorized, found on 12 desktops
  for (const asset of installDesktops.slice(0, 12)) {
    const key = `${bankTenant.id}:${asset.id}:${swCatalog[21].id}`;
    if (!usedKeys.has(key)) { usedKeys.add(key); installationRecords.push({ tenantId: bankTenant.id, assetId: asset.id, softwareId: swCatalog[21].id, version: '6.24', installPath: 'C:\\Program Files\\WinRAR', installDate: new Date(now.getTime() - 200 * 86400000), lastUsedAt: new Date(now.getTime() - 5 * 86400000) }); }
  }
  // Java 8 (22) — EOL runtime on 8 servers (Finacle dependency)
  for (const asset of installServers.slice(0, 8)) {
    const key = `${bankTenant.id}:${asset.id}:${swCatalog[22].id}`;
    if (!usedKeys.has(key)) { usedKeys.add(key); installationRecords.push({ tenantId: bankTenant.id, assetId: asset.id, softwareId: swCatalog[22].id, version: '8u361', installPath: '/usr/lib/jvm/java-8-oracle', installDate: new Date(now.getTime() - 400 * 86400000), lastUsedAt: new Date(now.getTime() - 86400000) }); }
  }
  // Flash Player (23) — EOS/blacklisted on 2 ATM controllers (desktop type)
  for (const asset of installDesktops.slice(70, 72)) {
    const key = `${bankTenant.id}:${asset.id}:${swCatalog[23].id}`;
    if (!usedKeys.has(key)) { usedKeys.add(key); installationRecords.push({ tenantId: bankTenant.id, assetId: asset.id, softwareId: swCatalog[23].id, version: '32.0.0.371', installPath: 'C:\\Windows\\System32\\Macromed\\Flash', installDate: new Date('2019-06-15'), lastUsedAt: new Date(now.getTime() - 30 * 86400000) }); }
  }
  // Slack (24) — needs review, informally installed on 15 laptops
  for (const asset of installLaptops.slice(40, 55)) {
    const key = `${bankTenant.id}:${asset.id}:${swCatalog[24].id}`;
    if (!usedKeys.has(key)) { usedKeys.add(key); installationRecords.push({ tenantId: bankTenant.id, assetId: asset.id, softwareId: swCatalog[24].id, version: '4.38.125', installPath: 'C:\\Users\\*\\AppData\\Local\\slack', installDate: new Date(now.getTime() - 60 * 86400000), lastUsedAt: new Date(now.getTime() - 86400000) }); }
  }
  // BitTorrent (9) — blacklisted, detected on 3 laptops
  for (const asset of installLaptops.slice(100, 103)) {
    const key = `${bankTenant.id}:${asset.id}:${swCatalog[9].id}`;
    if (!usedKeys.has(key)) { usedKeys.add(key); installationRecords.push({ tenantId: bankTenant.id, assetId: asset.id, softwareId: swCatalog[9].id, version: '7.11.0', installPath: 'C:\\Program Files\\BitTorrent', installDate: new Date(now.getTime() - 45 * 86400000), lastUsedAt: new Date(now.getTime() - 7 * 86400000) }); }
  }
